...
Macでもほぼ同様に簡単で、[公式ページ](https://github.com/kahst/BirdNET-Analyzer?tab=readme-ov-file#introduction)の Click here to download the macOS package からソフトをダウンロードできます。
